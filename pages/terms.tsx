...
export default function terms({}: Props) {
  return (
    <div className="max-w-5xl px-4 m-auto mt-32">
      <h2 className="font-serif text-xl">Terms and Conditions</h2>

      <p className="my-4 text-gray-800">
        These terms and conditions outline the rules and regulations for the use
        of this website, located at {client.website}.
      </p>
      <p className="my-4 text-gray-800">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use {client.website} if you do not agree
      ...
      <p className="my-4 text-gray-800">
        ...
        “Our” and “Us”, refers to our Company ({client.name}). “Party”,
      ...
      <p className="my-4 text-gray-800">
        We employ the use of cookies. By accessing {client.website}, you agreed
        to use cookies in per the terms of our our Privacy Policy.
      </p>
      <p className="my-4 text-gray-800">
        Most interactive websites use cookies to let us retrieve the user's
        details for each visit. Cookies are used by our website to enable the
        functionality of certain areas to make it easier for people visiting our
        website. Some of our advertising partners may also use cookies.
      </p>
      <h3>
        <strong>License</strong>
      </h3>
      <p className="my-4 text-gray-800">
        Unless otherwise stated,{client.name}
        and/or its licensors own the intellectual property rights for all
        material on {client.website}. All intellectual property rights are
        reserved. You may access this from {client.website} for your own
        personal use subjected to restrictions set in these terms and
        conditions.
      </p>
      <p className="my-4 text-gray-800">You must not:</p>
      <ul className="pl-8 list-disc">
        <li>Republish material from {client.website}.</li>
        <li>Sell, rent or sub-license material from {client.website}.</li>
        <li>Reproduce, duplicate or copy material from {client.website}.</li>
        <li>Redistribute content from {client.website}.</li>
      </ul>
      <p className="my-4 text-gray-800">
      ...
      <p className="my-4 text-gray-800">
        ...
        the hyperlink compensates the absence of {client.name}; and (d) the link
      ...
      <p className="my-4 text-gray-800">
        ...
        e-mail to {client.name}. Please include your name, your organization
      ...
      <p className="my-4 text-gray-800">
        No use of {client.name}'s logo or other artwork will be allowed for
